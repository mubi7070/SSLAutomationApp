...
const EmailTemplates = () => {
  ...
  //   // Map for dynamic replacement values
  //   const replacements = {
  //     [defaultClubName]: clubName || defaultClubName,
  ...
  //       return {
  //         ...template,
  //         subject: Object.keys(replacements).reduce(
  //           (result, key) => result.replace(key, replacements[key]),
  //           template.subject
  //         ),
  //         content: Object.keys(replacements).reduce(
  //           (result, key) => result.replace(key, replacements[key]),
  //           template.content
  //         ),
  //       };
