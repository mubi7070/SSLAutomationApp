...
export default function ServerMigration() {
  ...
  const handleGenerateSourceScript = async () => {
    ...
    try {
      ...
      element.download = `migration-source-${clientName}.ps1`;
      document.body.appendChild(element);
      element.click();
      document.body.removeChild(element);
      
      setSourceStatus('Script downloaded. Please run as administrator on source server.');
      setPopupMessage('Source script generated successfully');
    } catch (error) {
